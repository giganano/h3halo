...
Additional vector quantities which appear in our derivation are also noted.
}
...
This penalty encourages parsimony, rewarding models which explain the
...
for optimzation along with the term incorporating the determinants of the
covariance matrices.
