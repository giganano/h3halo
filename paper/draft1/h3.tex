...
the halo~\citep[e.g.,][]{Roederer2019, Wan2020, Martin2020} and a high fraction
...
\begin{itemize}
	...
	\item[\textbf{1.}] $(J_z - J_r) / J_\text{tot}$ > 0.7, where~$J$ is
	angular momentum.
...
GSE contamination, though from our modelling of the~\afe-\feh~distribution (see
Fig.~\ref{fig:wukong}), it appears that the MDF cuts off around~$\sim$$-1.5$
anyway.
