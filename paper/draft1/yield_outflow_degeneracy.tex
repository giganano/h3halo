...
models that assume~$\eta = 0$ as otherwise unphysically high metal abundances
will arise.
...
new pathway for constraining the early epochs of star formation in both intact
