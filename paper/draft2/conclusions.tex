...
\par
{\color{red}
Given the considerable uncertainties affecting stellar models (see discussion
in~\S~\ref{sec:h3:yields}), our method's ability to empirically infer elemental
yields and marginalize over uncertainties therein is powerful.
It would be straightforward to significantly extend what we have demonstrated
here, such as introducing the shape of a delay-time distribution or metallicity
dependence as additional free parameters.
}
