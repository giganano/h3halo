...
$\yacc = \scinote{1.2}{-4}$ in this paper to set the scale of this degeneracy.
...
the oxygen yield from massive stars is fixed at~$\yacc = \scinote{1.2}{-4}$,
though if outflows are to be neglected, the assumption of~$\eta = 0$ fulfills
the same purpose.
...
$\yacc = \scinote{1.2}{-4}$, we find a degeneracy of the opposite sign; see
discussion in~\S~\ref{sec:mocks:recovered} and in~\citealt{Weinberg2017}).
