...
\begin{itemize}
	...
	\script{M} with~$K$ points in its piece-wise linear form, the likelihood
	...
	\begin{itemize}
		...
		be subtracted from equation~\refp{eq:likelihood} (for justirication,
	...
	according to equation~\refp{eq:likelihood} and let~\mc~take care of
	the rest.
