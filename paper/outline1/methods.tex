...
\begin{itemize}
	...
	\item The validity of equation~\refp{eq:likelihood} is contingent on a
	handful of assumptions regarding the data~\script{D} and predicted
	track~\script{M}.
	We discuss them individually below, noting how equation~\refp{eq:likelihood}
